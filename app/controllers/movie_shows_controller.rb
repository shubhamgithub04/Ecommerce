class MovieShowsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @movie_show.save
        format.html { redirect_to movie_show_url(@movie_show), notice: "Movie show was successfully created." }
  ...
  def update
    respond_to do |format|
      if @movie_show.update(movie_show_params)
        format.html { redirect_to movie_show_url(@movie_show), notice: "Movie show was successfully updated." }
  ...
  private
    ...
    def movie_show_params
      params.require(:movie_show).permit(:movie_id, :show_date, :show_slot)
    end
end
